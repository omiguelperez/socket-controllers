...
[![Build Status](https://travis-ci.com/omiguelperez/socket.io-ts-event-controllers.svg?branch=master)](https://travis-ci.com/omiguelperez/socket.io-ts-event-controllers)
[![npm version](https://badge.fury.io/js/socket.io-ts-event-controllers.svg)](https://badge.fury.io/js/socket.io-ts-event-controllers)

Use class-based controllers to handle websocket events. Helps to organize your code using websockets in classes.

## Installation

1. Install `socket.io-ts-event-controllers`:

    ```
    npm install socket.io-ts-event-controllers
    ```
...
1. Create a file `MessageController.ts`
    ...
    ```typescript
    import {OnConnect, SocketController, ConnectedSocket, OnDisconnect, MessageBody, OnMessage, OnPacket} from "socket.io-ts-event-controllers";
...
2. Create a file `app.ts`
    ...
    import {createSocketServer} from "socket.io-ts-event-controllers";
...
```typescript
import {SocketController, OnConnect, OnDisconnect} from "socket.io-ts-event-controllers";
...
```typescript
import {SocketController, OnMessage, ConnectedSocket} from "socket.io-ts-event-controllers";
...
```typescript
import {SocketController, OnMessage, MessageBody} from "socket.io-ts-event-controllers";
...
socket.io-ts-event-controllers will use [class-transformer][1] to create instance of the given class type with the data received in the message.
...
```typescript
import {SocketController, OnMessage, EmitOnSuccess} from "socket.io-ts-event-controllers";
...
```typescript
import {SocketController, OnMessage, EmitOnSuccess, EmitOnFail} from "socket.io-ts-event-controllers";
...
```typescript
import {SocketController, OnMessage, EmitOnSuccess, EmitOnFail, SkipEmitOnEmptyResult} from "socket.io-ts-event-controllers";
...
```typescript
import "reflect-metadata"; // this shim is required
import {useSocketServer} from "socket.io-ts-event-controllers";
...
```typescript
import {Middleware, MiddlewareInterface} from "socket.io-ts-event-controllers";
